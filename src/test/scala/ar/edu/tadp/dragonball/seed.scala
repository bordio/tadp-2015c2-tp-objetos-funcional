...
package object seed {
  ...
  val vegeta: Guerrero = Guerrero("vegeta", List(FotoDeLaLuna,SemillaDelErmitanio), 500, 1000, Saiyajin(Normal), Luchando, Ataques ++ List[Movimiento](UsarItem(FotoDeLaLuna)))
  ...
  val piccolo: Guerrero = Guerrero("Piccolo", List(), 1000, 1000, Namekusein, Luchando, Ataques ++ List[Movimiento](Magia(hacertePensar)))
